...
Economics v1.7.7 has produced and verified 7 of 8 official modules (ECO-LM1, The Firm and Market Structures; ECO-LM2, Understanding Business Cycles; ECO-LM3, Fiscal Policy; ECO-LM4, Monetary Policy; ECO-LM5, Introduction to Geopolitics; ECO-LM6, International Trade; ECO-LM7, Capital Flows and the FX Market). The remaining module (ECO-LM8) has no public lesson assets and remains mapping-only pending its own production release.
