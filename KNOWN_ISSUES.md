...
Economics v1.7.6 has produced and verified 6 of 8 official modules (ECO-LM1, The Firm and Market Structures; ECO-LM2, Understanding Business Cycles; ECO-LM3, Fiscal Policy; ECO-LM4, Monetary Policy; ECO-LM5, Introduction to Geopolitics; ECO-LM6, International Trade). The remaining two modules (ECO-LM7–ECO-LM8) have no public lesson assets and remain mapping-only pending their own production releases.
