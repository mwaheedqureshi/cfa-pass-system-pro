...
- **Current release:** v1.8.6 — FSA Module Production Sprint 6 (FSA-LM6 Analysis of Inventories)
...
- **Current version:** v1.8.6 — FSA Module Production Sprint 6
- **Current sprint:** FSA-LM3 produced and verified.
- **Next sprint:** FSA-LM7 production; not begun in v1.8.6.
