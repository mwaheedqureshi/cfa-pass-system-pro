...
- **Current release:** v1.8.5 — FSA Module Production Sprint 5 (FSA-LM5 Analyzing Statements of Cash Flows II)
...
- **Current version:** v1.8.5 — FSA Module Production Sprint 5
- **Current sprint:** FSA-LM3 produced and verified.
- **Next sprint:** FSA-LM6 production; not begun in v1.8.5.
