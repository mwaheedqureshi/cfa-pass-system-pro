...
describe('FSA topics in long-term liabilities and equity',()=>{
 ...
 it('registers LM8 as the eighth verified FSA module',()=>{expect(lessons.find(l=>l.id==='fsa-08-topics-in-long-term-liabilities-and-equity')?.formulaIds).toHaveLength(11);expect(verifiedOfficialFsaModules).toHaveLength(10)});
});
