...
describe('2027 Economics curriculum map',()=>{
 ...
 it('marks exactly ECO-LM1 through ECO-LM7 as verified after this release',()=>{
 ...
 it('derives economics lesson ids only from published modules',()=>{
  expect(economicsLessonIds).toEqual(['economics-firm-market-01','economics-02-understanding-business-cycles','economics-03-fiscal-policy','economics-04-monetary-policy','economics-05-introduction-to-geopolitics','economics-06-international-trade','economics-07-capital-flows-and-the-fx-market']);
 });
});
