...
{id:'quantitative-methods',title:'Quantitative Methods',description:'Statistical tools, rates of return, probability, and financial mathematics.',lessonCount:1,status:'available'},
{id:'economics',title:'Economics',description:'Microeconomics, macroeconomics, and international trade.',lessonCount:0,status:'pending'},
