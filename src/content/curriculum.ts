...
{id:'corporate-issuers',title:'Corporate Issuers',description:'Organizational forms, ownership, stakeholders, governance, capital allocation, financing, and business models.',lessonCount:3,status:'available'},
{id:'financial-statement-analysis',title:'Financial Statement Analysis',description:'Financial reporting and analytical techniques.',lessonCount:1,status:'available'},
